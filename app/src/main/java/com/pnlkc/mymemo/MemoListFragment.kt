...
import com.pnlkc.mymemo.databinding.FragmentMemoListBinding
import com.pnlkc.mymemo.recyclerview_memo_list.IListRecyclerVIew
import com.pnlkc.mymemo.recyclerview_memo_list.ListAdapter
...
class MemoListFragment : Fragment(), IListRecyclerVIew {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.memoAddBtn.setOnClickListener {
            ...
            memoViewModel.memoLastId = memoViewModel.readAllData.value!!.last().id
            if (memoViewModel.selectedLabel.value != null) {
